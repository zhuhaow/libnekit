...
///   el::ConfigurationType::Enabled, "true"); * el::Configuration
///   confMaxLogFileSizeInfo(el::Level::Info,
///   el::ConfigurationType::MaxLogFileSize, "2048"); * el::Configuration
///   confFilenameInfo(el::Level::Info, el::ConfigurationType::Filename,
///   "/var/log/my.log");
...
class TypedConfigurations : public base::threading::ThreadSafe {
 ...
 private:
  ...
  template <typename Conf_T>
  Conf_T& unsafeGetConfigByRef(Level level, std::map<Level, Conf_T>* confMap,
                               const char* confName) {
    ELPP_UNUSED(confName);
