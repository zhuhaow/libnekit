...
#endif
#if defined(HEDLEY_GNUC_VERSION) && !defined(__clang) &&              \
...
#elif HEDLEY_GNUC_HAS_EXTENSION(attribute_deprecated_with_message, 4, 5, 0) || \
...
#elif HEDLEY_GNUC_HAS_ATTRIBUTE(deprcated, 3, 1, 0) ||                       \
...
#endif
#if HEDLEY_GNUC_HAS_ATTRIBUTE(warning, 4, 3, 0) || \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0)
...
#elif HEDLEY_GNUC_HAS_ATTRIBUTE(warn_unused_result, 3, 4, 0) ||        \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) ||                            \
...
#endif
#if HEDLEY_GNUC_HAS_ATTRIBUTE(sentinel, 4, 0, 0) || \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) || HEDLEY_ARM_VERSION_CHECK(5, 4, 0)
...
#elif HEDLEY_GNUC_HAS_ATTRIBUTE(noreturn, 3, 2, 0) ||                          \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) ||                                    \
...
#endif
#if (HEDLEY_GNUC_HAS_BUILTIN(__builtin_unreachable, 4, 5, 0) && \
     !defined(__CC_ARM)) ||                                     \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0)
...
#endif
#if HEDLEY_GNUC_HAS_ATTRIBUTE(nonnull, 3, 3, 0) || \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) || HEDLEY_ARM_VERSION_CHECK(4, 1, 0)
...
#endif
#if HEDLEY_GNUC_HAS_BUILTIN(__builtin_expect, 3, 0, 0) ||                      \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) ||                                    \
    HEDLEY_SUNPRO_VERSION_CHECK(5, 12, 0) ||                                   \
    HEDLEY_ARM_VERSION_CHECK(4, 1, 0) || HEDLEY_IBM_VERSION_CHECK(10, 1, 0) || \
    HEDLEY_TI_VERSION_CHECK(7, 3, 0) || HEDLEY_TINYC_VERSION_CHECK(0, 9, 27)
...
#undef HEDLEY_MALLOC
#endif
#if HEDLEY_GNUC_HAS_ATTRIBUTE(malloc, 3, 1, 0) ||                              \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) ||                                    \
    HEDLEY_SUNPRO_VERSION_CHECK(5, 11, 0) ||                                   \
...
#undef HEDLEY_PURE
#endif
#if HEDLEY_GNUC_HAS_ATTRIBUTE(pure, 2, 96, 0) ||                               \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) ||                                    \
    HEDLEY_SUNPRO_VERSION_CHECK(5, 11, 0) ||                                   \
    HEDLEY_ARM_VERSION_CHECK(4, 1, 0) || HEDLEY_IBM_VERSION_CHECK(10, 1, 0) || \
    HEDLEY_TI_VERSION_CHECK(8, 0, 0) ||                                        \
...
#elif HEDLEY_GNUC_VERSION_CHECK(3, 1, 0) ||                                    \
...
#endif
#if HEDLEY_GNUC_HAS_ATTRIBUTE(always_inline, 4, 0, 0) ||                       \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) ||                                    \
    HEDLEY_SUNPRO_VERSION_CHECK(5, 11, 0) ||                                   \
    HEDLEY_ARM_VERSION_CHECK(4, 1, 0) || HEDLEY_IBM_VERSION_CHECK(10, 1, 0) || \
    HEDLEY_TI_VERSION_CHECK(8, 0, 0) ||                                        \
...
#else
#if HEDLEY_GNUC_VERSION_CHECK(3, 3, 0) ||                                      \
    HEDLEY_SUNPRO_VERSION_CHECK(5, 11, 0) ||                                   \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) ||                                    \
...
#endif
#if HEDLEY_GNUC_HAS_ATTRIBUTE(nothrow, 3, 3, 0) || \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0)
...
#endif
#if defined(__cplusplus) && \
    (!defined(__SUNPRO_CC) || HEDLEY_SUNPRO_VERSION_CHECK(5, 15, 0))
...
#define HEDLEY_FALL_THROUGH [[clang::fallthrough]]
    ...
    HEDLEY_GNUC_HAS_CPP_ATTRIBUTE(gnu::fallthrough, 7, 0, 0)
...
#endif
#if HEDLEY_GNUC_HAS_ATTRIBUTE(returns_nonnull, 4, 9, 0) || \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0)
...
#if HEDLEY_GNUC_VERSION_CHECK(3, 1, 0) ||   \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) || \
    HEDLEY_TINYC_VERSION_CHECK(0, 9, 19) || \
    HEDLEY_ARM_VERSION_CHECK(5, 4, 0) || HEDLEY_IBM_VERSION_CHECK(13, 1, 0)
#define HEDLEY_IS_CONSTANT(expr) __builtin_constant_p(expr)
#endif
#if !defined(__cplusplus)
#if HEDLEY_GNUC_VERSION_CHECK(3, 1, 0) || \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) || HEDLEY_IBM_VERSION_CHECK(13, 1, 0)
...
#define HEDLEY__IS_CONSTEXPR(expr) \
  __builtin_types_compatible_p(    \
    ...
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0) || HEDLEY_IBM_VERSION_CHECK(12, 1, 0)
#if defined(__INTPTR_TYPE__)
#define HEDLEY__IS_CONSTEXPR(expr)                                            \
...
#endif
#elif defined(HEDLEY_GNUC_VERSION) || defined(HEDLEY_INTEL_VERSION) || \
...
#undef HEDLEY_STATIC_ASSERT
    ...
    ((defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L)) || \
     ...
     HEDLEY_INTEL_VERSION_CHECK(15, 0, 0) || defined(_Static_assert))
...
#define HEDLEY_MESSAGE(msg)                 \
  ...
  HEDLEY_DIAGNOSTIC_POP
#elif HEDLEY_GNUC_VERSION_CHECK(4, 4, 0) || HEDLEY_INTEL_VERSION_CHECK(16, 0, 0)
...
#define HEDLEY_WARNING(msg)                 \
  ...
  HEDLEY_DIAGNOSTIC_POP
#elif (HEDLEY_GNUC_VERSION_CHECK(4, 8, 0) && !defined(__PGI)) || \
    HEDLEY_INTEL_VERSION_CHECK(16, 0, 0)
